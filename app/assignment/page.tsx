        ...
        <main className="flex flex-col gap-8 min-w-0">
          ...
          >
            <p className="text-[#CBD5E1] leading-relaxed">
              We started from{" "}
              <a
                href="https://www.kaggle.com/datasets/maharshipandya/-spotify-tracks-dataset?resource=download&select=dataset.csv"
                target="_blank"
          ...
          >
            <p className="text-[#CBD5E1] leading-relaxed">
              ...
              Click a file to preview the first 25 rows.
            </p>
            <CSVBrowser />
          </Section>
